...
import Lording from '../../components/student/Lording'
...
<div className='absolute top-0 left-0 w-full h-section-height-f-1 bg-gradient-to-b from-cyan-100/70'>

</div>

{/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className=' md:text-cqurse-deatails-heading-large text-course-deatails-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
        <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html :courseData.courseDescription.slice(0,200) }}></p>


        {/* Review and rating  */}
         <div className='flex place-items-center space-x-2 pt-3 pb-1 text-sm'>
                  ...
                  <p text-sm>Course by <span className='text-blue-600 underline '>AN Education</span></p>
...
<div className='pt-6 '>
  <p className='md:text-xl text-lg front-medium text-gray-800'>What's in the course ?</p>
